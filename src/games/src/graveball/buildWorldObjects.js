...
export default function (platform) {
	...
	const plane = new Plate(10000, 10, 10000, 0, brightSquaresTexture);
	plane.receiveShadow = true;
	platform.push(plane);
	worldObjects.push(plane);
	plane.position.set(0, 0, 0);

	const wall = new Plate(100, 1000, 10000, 0.05, brickTexture);
	wall.receiveShadow = true;
	platform.push(wall);
	worldObjects.push(wall);
	wall.position.set(5000, 0, 0);

	const wall2 = new Plate(10000, 1000, 100, 0.05, brickTexture);
	wall2.receiveShadow = true;
	platform.push(wall2);
	worldObjects.push(wall2);
	wall2.position.set(0, 0, 5000);

	const tower = new Plate(500, 500, 500, 0.05, streetTexture);
	tower.receiveShadow = true;
	platform.push(tower);
	worldObjects.push(tower);
	tower.position.set(0, 150, 0);

	const r1 = new Plate(500, 100, 1500, 0.05, streetTexture);
	...
	const r2 = new Plate(500, 100, 1500, 0.05, streetTexture);
	...
	const r3 = new Plate(1500, 100, 500, 0.05, streetTexture);
	...
	const r4 = new Plate(1500, 100, 500, 0.05, streetTexture);
	...
	const tower2 = new Plate(2000, 800, 3000, 0.05, streetTexture);
