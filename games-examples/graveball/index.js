...
class Graveball extends threeEngine {
	loadKit(kit) {
		// kit.enableCountdown();
		this.platform = [];
		this.objMovable = [];
...
const graveball = new Graveball();

export default {
	renderOn: graveball.renderOn.bind(graveball),
	startRender: graveball.startRender.bind(graveball),
	stopRender: graveball.stopRender.bind(graveball),
	setSize: graveball.setSize.bind(graveball),
	loadKit: graveball.loadKit.bind(graveball),
	controls: {
		'Up arrow': 'move camera close',
		'Down arrow': 'move camera away',
